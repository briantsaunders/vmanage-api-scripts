...
def main(args):
    ...
    device_data = device_lib.get_device_data(
        args.device_data_path, device_status["system-ip"]
    )
    print(json.dumps(device_data, indent=4, sort_keys=True))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        action="store",
        help="vmanage device data path - i.e. interface, ip/routetable",
    )
